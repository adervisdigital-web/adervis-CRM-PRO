...
function mailFor(stage: 1 | 3 | 6, appUrl: string): Mail {
  ...
  return {
    ...
    intro: "Завтра пробный период заканчивается. Чтобы не потерять доступ к сделкам, сметам и клиентским КП, оформите подписку — от 490 ₽/мес, это дешевле одного часа монтажа.",
    steps: [
      ["Все данные сохранятся", "Сделки, клиенты, сметы и настройки никуда не денутся — продолжите с того же места"],
      ["Тарифы от 490 ₽/мес", "Помесячно, на 3/6 месяцев или год — чем длиннее, тем выгоднее"],
    ],
    cta: "Выбрать тариф",
    href: appUrl,
